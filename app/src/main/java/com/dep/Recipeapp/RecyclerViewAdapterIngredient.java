...
public class RecyclerViewAdapterIngredient extends RecyclerView.Adapter<RecyclerViewAdapterIngredient.MyViewHolder> {
    ...
    RecyclerViewAdapterIngredient(Context mContext, List<PresentIngredient> mData) {
    ...
    public void onBindViewHolder(final RecyclerViewAdapterIngredient.MyViewHolder holder, final int position) {
        ...
        if (mData.get(position).isSelected()) holder.cardView.setCardBackgroundColor(Color.parseColor("#F75900"));
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mData.get(position).isSelected()) {
                    holder.cardView.setCardBackgroundColor(Color.parseColor("#F75900"));
